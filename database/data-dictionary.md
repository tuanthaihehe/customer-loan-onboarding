...
| `applicant_full_name` | `varchar(255)` | No |  | Snapshot họ tên khách hàng tại bước lưu thông tin sơ bộ. |
| `applicant_identity_number` | `varchar(20)` | No |  | Snapshot số CCCD/giấy tờ định danh tại bước lưu thông tin sơ bộ. |
| `applicant_phone_number` | `varchar(20)` | No |  | Snapshot số điện thoại tại bước lưu thông tin sơ bộ. |
| `applicant_date_of_birth` | `date` | No |  | Snapshot ngày sinh tại bước lưu thông tin sơ bộ. |
| `applicant_gender` | `varchar(30)` | No | Check enum | Giới tính khách hàng trên màn hình thông tin sơ bộ. |
| `applicant_occupation` | `varchar(100)` | No |  | Nghề nghiệp khách hàng trên màn hình thông tin sơ bộ. |
| `applicant_monthly_income` | `numeric(18,2)` | No | Check > 0 nếu có giá trị | Thu nhập hàng tháng trên màn hình thông tin sơ bộ. |
...
- Các trường `applicant_*` là snapshot tại thời điểm lưu thông tin sơ bộ, dùng để giữ đúng dữ liệu hồ sơ vay kể cả khi thông tin khách hàng thay đổi sau này.
