...
| ID | Task | Status |
|---|---|---|
| BE-001 | Dựng Spring Boot backend | Done |
| BE-002 | Health API | Done |
| BE-003 | Swagger/OpenAPI | Done |
| BE-004 | ApiResponse chuẩn | Done |
| BE-005 | Exception handling | Done |
| BE-006 | Customer lookup API | Done |
| BE-007 | Loan application draft API | Done |
| BE-008 | Asset lookup/snapshot API | Done |
| BE-009 | Asset valuation preview API | Done |
...
| ID | Task | Lý do hoãn |
|---|---|---|
| BE-030 | Unit test chi tiết cho rule | Rule chưa chốt |
| BE-031 | Controller test chi tiết | API/rule còn có thể đổi |
