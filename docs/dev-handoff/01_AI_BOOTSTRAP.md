...
Backend hiện tại là Spring Boot mock-first demo cho Flow 1: tạo hồ sơ vay và gửi đi phê duyệt.
...
Ưu tiên giữ API chạy được trên Swagger, mock data rõ ràng, tài liệu markdown đồng bộ.
Khi thêm/sửa code, phải đảm bảo service dùng mock data provider trong package mock, controller chỉ gọi service, response dùng ApiResponse<T>.
```
...
- service có tách mock data không;
